...
(params1, _, y1, yhat1, num_errors1) = lstm.predict('params_2y_1L128_09i.yaml')
plot.prediction(y1, yhat1, num_errors1, params2, inv_scale=True, inv_log=True)

(params2, _, y2, yhat2, num_errors2) = lstm.predict('params_2y_4L128_09i.yaml')
plot.prediction(y2, yhat2, num_errors2, params2, inv_scale=True, inv_log=True)

(params3, _, y3, yhat3, num_errors3) = lstm.predict('params_3y_4L128_09i.yaml')
plot.prediction(y3, yhat3, num_errors3, params3, inv_scale=True, inv_log=True)

(params4, _, y4, yhat4, num_errors4) = lstm.predict('params_3y_1L256_09i.yaml')
