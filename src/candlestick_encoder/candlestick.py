class Candlestick:
    ...
    def calc_parameters(self):
        ...
        self.shadows_relative_diff = abs(
            self.upper_shadow_percentile - self.lower_shadow_percentile)
    ...
    def info(self):
        ...
        print('body center percentile: {:0.2f}'.format(
            self.mid_body_percentile))
        print('body min/max percentiles: {:0.2f}/{:0.2f}'.format(
        ...
        print('up/lw shdws width: {:0.2f}/{:0.2f}'.format(
            self.upper_shadow_percentile, self.lower_shadow_percentile))
        print('up/lw relative diff: {:0.2f}'.format(
            self.shadows_relative_diff))
        print('upper/lower shadows? {}/{}'.format(self.has_upper_shadow,
                                                  self.has_lower_shadow))
