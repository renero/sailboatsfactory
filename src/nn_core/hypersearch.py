...
for hpv1 in hyperparams['lstm_num_epochs']:
    params['lstm_num_epochs'] = hpv1
    for hpv2 in hyperparams['lstm_batch_size']:
        params['lstm_batch_size'] = hpv2
        for hpv3 in hyperparams['lstm_timesteps']:
